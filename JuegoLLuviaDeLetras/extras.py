...
def dibujar(screen, candidata, listaIzq, listaMedio, listaDer, posicionesIzq ,
    ...
    #Linea del piso
    pygame.draw.line(screen, (50, 100, 100), (0, ALTO-70) , (ANCHO, ALTO-70), 5)

    #linea vertical
    pygame.draw.line(screen, (50, 100, 100), (ANCHO//3, ALTO-70) , (ANCHO//3, 0), 5)

    #linea vertical
    pygame.draw.line(screen, (50, 100, 100), (2*ANCHO//3, ALTO-70) , (2*ANCHO//3, 0), 5)
    ...
    for i in range(len(listaMedio)):
        screen.blit(defaultFont.render(listaMedio[i], 1, COLOR_LETRAS_Med), posicionesMedio[i])
